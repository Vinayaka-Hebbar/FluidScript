...
namespace FluidScipt.ConsoleTest
{
    public class Class1
    {
        ...
        private void Run()
        {
            ...
            context["a"] = new FluidScript.Double(715.77);
            context["b"] = new FluidScript.Double(1.3426);
            var statement = engine.GetStatement("return 1");
...
#if Required
        public sealed class ColumnDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
        {
            public struct Entry
            {
            ...
            public ColumnDictionary() : this(0, null) { }

            public ColumnDictionary(int capacity) : this(capacity, null) { }

            public ColumnDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

            public ColumnDictionary(int capacity, IEqualityComparer<TKey> comparer)
            {
            ...
            public ColumnDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

            public ColumnDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
        ...
        #region IDicitonary
            ...
            object IDictionary.this[object key]
            {
                ...
                set
                {
                    ...
                    try
                    {
                        ...
                        {
                            throw new ArgumentException(string.Concat("Wrong value type ", typeof(TValue)));
                        }
                    }
                    catch (InvalidCastException)
                    {
                        throw new ArgumentException(string.Concat("Wrong value type ", typeof(TKey)));
                    }
                }
            }
            ...
            {
                private ColumnDictionary<TKey, TValue> dictionary;
                private int version;
                private int index;
                ...
                internal Enumerator(ColumnDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
                {
            ...
            {
                private readonly ColumnDictionary<TKey, TValue> dictionary;

                public KeyCollection(ColumnDictionary<TKey, TValue> dictionary)
                {
                ...
                public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
                {
                    ...
                    internal Enumerator(ColumnDictionary<TKey, TValue> dictionary)
                    {
                        this.dictionary = dictionary;
                        version = dictionary.version;
                        index = 0;
            ...
            public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
            {
                ...
                public ValueCollection(ColumnDictionary<TKey, TValue> dictionary)
                {
                    if (dictionary == null)
                    {
                        throw new ArgumentNullException(nameof(dictionary));
