...
{
    internal sealed class Keywords : OperationContext, IReadOnlyOperationContext, IOperationContext, IEnumerable<KeyValuePair<string, Object>>
    {
        ...
        public Keywords() : base(functions, mathConstants)
        {
            Identifiers = new Dictionary<string, IdentifierType>(identifiers);
            ReadOnlyContext = this;
        }

        public Keywords(IEqualityComparer<string> comparer) : base(functions, mathConstants, comparer)
        {
