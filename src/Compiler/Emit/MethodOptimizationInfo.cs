...
namespace FluidScript.Compiler.Emit
{
    ...
    /// </summary>
    public sealed class MethodOptimizationInfo : OptimizationInfo
    {
        ...
        public MethodOptimizationInfo(OptimizationInfo info) : base(info)
        {

        }

        public MethodOptimizationInfo(Func<string, bool, Type> resolveType) : base(resolveType)
        {
        }
