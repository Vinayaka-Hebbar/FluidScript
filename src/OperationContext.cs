...
namespace FluidScript
{
    ...
    {
        internal static readonly InbuiltContext Inbuilt = new InbuiltContext();
        ...
        public IFunctionPart<IExpression, Object> GetFunctionPart(string name, int argCount, Scope scope)
        {
